...
export const projects = [
  {
    ...
    year: "2024 - Ongoing",
    platform: "Various",
    description: "株式会社HIKKY「バーチャルマーケット（Vket）」「Vket Cloud」等でのドキュメント執筆・英翻訳および、日・英ユーザーサポートを担当。",
...
ドキュメントの更新・管理フローの設計・導入支援。また、チームメンバーに対する技術的ナレッジの共有やフォローアップも行っています。`
  },
  {
    ...
    description: "派手な演出のVRイライラ棒ゲーム。企画・ディレクション、ビジュアルデザイン、PV制作などを担当。MMC25 “Other-Misc”部門 優勝。",
    category: "Game",
...
`
  },
  {
    ...
    year: "2025",
    platform: "Resonite",
    description: "VketReal 2025 Summerコンテンツ「イマーシブストア」のギミック制作・ワールド改修および演者向けサポートを担当。©株式会社HIKKY。",
    category: "Gimmick",
...
https://twitter.com/SawaeMika/status/1948943433571438852`
  },
  {
    ...
    year: "2024",
    platform: "Resonite",
    description: "VketReal 2024 Summerにてバーチャル×リアル連動コンテンツ「AVATAR MEETS」の3Dアセットを制作。©WeaverseLab株式会社。",
    category: "Assets",
    tags: ["3D Assets"],
...
![Train Light画像](/images/TrainLight4.webp)`
  },
  {
    ...
    description: "縦スクロールジャンプアクションゲーム。Unity1週間ゲームジャム参加作品。企画・ディレクション、2Dデザインなどを担当。",
    category: "Game",
    tags: ["Director"],
